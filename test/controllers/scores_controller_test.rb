...
class ScoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create score" do
    assert_difference('Score.count') do
      post scores_url, params: { score: { person_id: @score.person_id, point_verite_id: @score.point_verite_id } }
    end
  ...
  test "should update score" do
    patch score_url(@score), params: { score: { person_id: @score.person_id, point_verite_id: @score.point_verite_id } }
